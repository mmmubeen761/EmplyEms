    ...
    <div class="main">
        <div class="navbar-side">
            ...
            <ul>
                ...
                <li><a href="recieveproject.php" title="Category">
                    ...
                    <div class="col-lg-4 col-md-6 p-2">
                        <div class="card border-primary rounded-0">
                            <div class="card-header bg-primary rounded-0">
                                <h5 class="card-title text-white mb-1">Total Projects</h5>
                            </div>
                            <div class="card-body">
                                <h1 class="display-4 font-weight-bold text-primary text-center">00</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 p-2">
                        <div class="card border-success rounded-0">
                            <div class="card-header bg-success rounded-0">
                                <h5 class="card-title text-white mb-1">Recieve Project</h5>
                            </div>
                            <div class="card-body">
                                <h1 class="display-4 font-weight-bold text-success text-center">00</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 p-2">
                        <div class="card border-primary rounded-0">
                            <div class="card-header bg-primary rounded-0">
                                <h5 class="card-title text-white mb-1">Pending Projects</h5>
                            </div>
                            <div class="card-body">
                                <h1 class="display-4 font-weight-bold text-primary text-center">00</h1>
                            </div>
